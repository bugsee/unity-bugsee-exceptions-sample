...
namespace BugseePlugin
{
    ...
    public class Bugsee : MonoBehaviour
    {
        ...
        [DllImport("__Internal")]
        private static extern bool _bugsee_clear_all_attributes();
        ...
        public static bool ClearAllAttributes()
        {
            return _bugsee_clear_all_attributes();
        }
        ...
        public static void AddSecureRect(Rect pixelRect)
        {
            ...
            javaRect.Call("set", (int)pixelRect.xMin, (int)pixelRect.yMin, (int)pixelRect.xMax, (int)pixelRect.yMax);
        ...
        public static void Launch(string appToken, BugseeLaunchOptions options = null)
        {
            ...
            var serializedOptions = launchOptions.SerializeOptions();
            serializedOptions["allowChildProcessRun"] = true;
            Launch(appToken, serializedOptions);
        }
        ...
        public static bool ClearAllAttributes()
        {
            bugseeAdapterClass.CallStatic("clearAllAttributes");
            return true;
        }
        ...
        /// </summary>
        public static bool ClearAllAttributes() { return true; }
