...
public class Cube : MonoBehaviour
{
    ...
    void SendBugseeReport()
    {
        BugseePlugin.Bugsee.Upload("Test");
    }
    ...
    void TriggerCrash()
    {
        BugseePlugin.Bugsee.TestExceptionCrash();
    }
    ...
    void OnGUI()
    {
        ...
        if (GUI.Button(new Rect(210, 10, 200, 100), "Report", style)) SendBugseeReport();
        if (GUI.Button(new Rect(420, 10, 200, 100), "Throw", style)) ThrowException();
        if (GUI.Button(new Rect(630, 10, 200, 100), "Crash", style)) TriggerCrash();
